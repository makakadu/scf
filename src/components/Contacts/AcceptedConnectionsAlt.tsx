...
const AcceptedConnectionsAlt: React.FC<PropsType> = React.memo((props: PropsType) => {
      ...
      <div className={ classes.connection } key={contact.id} >
        ...
        <div style={{flexGrow: 1}}>
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <Typography component={NavLink} to={contactLink} variant='body2' style={{marginBottom: 8}} >
              <b>{ contactName }</b>
            </Typography>
          </div>
        </div>
...
export default AcceptedConnectionsAlt